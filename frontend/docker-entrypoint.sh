...
MINIKUBE_IP=${VITE_MINIKUBE_IP:-"localhost"}
API_GATEWAY_PORT=${VITE_API_GATEWAY_PORT:-"30080"}
KEYCLOAK_URL=${VITE_KEYCLOAK_URL:-"http://localhost:30090"}
KEYCLOAK_REALM=${VITE_KEYCLOAK_REALM:-"toolrent-realm"}
KEYCLOAK_CLIENT_ID=${VITE_KEYCLOAK_CLIENT_ID:-"toolrent-frontend"}
