...
public class KardexMovementService {
    ...
    public KardexMovementEntity createLoanMovement(ToolEntity tool, Integer quantity,
        ...
        //No validamos ni reservamos instancias aquí porque eso ya se hace en LoanService
    ...
    public KardexMovementEntity createRestockMovement(ToolEntity tool, Integer quantity,
        ...
        // No crear instancias aquí porque ToolService.addToolStock() ya las crea
        // registra el movimiento en el kardex
    ...
    public KardexMovementEntity createRepairMovement(ToolEntity tool, String description
        ...
        //Marcar instancia específica como en reparación
        if (instanceId != null) {
            try {
    ...
    //Validar disponibilidad de instancias antes de movimientos
    ...
    //Actualizar instancias basado en el tipo de movimiento
    ...
    private void validateMovementCreation(ToolEntity tool, KardexMovementEntity.MovementType type,
        ...
        // Validación más estricta para movimientos que afectan stock
        // No validamos aquí porque el stock ya fue actualizado antes de crear el movimiento
