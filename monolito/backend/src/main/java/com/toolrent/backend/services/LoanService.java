...
public class LoanService {
    ...
    public LoanEntity createLoan(LoanEntity loan) {
        try {
            ...
            // Guardar stock ANTES del movimiento para Kardex
            ...
            // Actualizar estado de la herramienta según el stock
            ...
            // actualizar instancias individuales de herramientas (opcional)
            ...
            // Guardar directamente con el repositorio para evitar validaciones innecesarias
    ...
    // Return tool - ESTADOS CORRECTOS E INSTANCIAS Y TIPOS DE DAÑO
    @Transactional
    public LoanEntity returnTool(Long loanId, Boolean damaged, String damageType, String notes) {
        try {
            ...
            // Actualizar stock Y estado de herramienta según el caso
            ToolEntity tool = loan.getTool();
            ...
            if (damaged != null && damaged) {
                ...
                // Actualizar instancias individuales a AVAILABLE
                if (toolInstanceService != null) {
                    try {
    ...
    protected ToolInstanceEntity tryReserveToolInstancesAndGetFirst(Long toolId, Integer quantity) {
        ...
        try {
            ...
            System.err.println("Could not reserve tool instances: " + e.getMessage());
            System.err.println("This is normal if tool instances are not configured for this tool.");
            System.err.println("Loan will proceed using only the main tool stock counter.");
            // Do NOT rethrow - instances are optional
            return null;
        } catch (Exception e) {
            System.err.println("Unexpected error reserving tool instances: " + e.getMessage());
            System.err.println("Loan will proceed using only the main tool stock counter.");
            // Do NOT rethrow - instances are optional
            return null;
        }
     ...
     * debería ser llamado periódicamente (diariamente) o bajo demanda
     *
